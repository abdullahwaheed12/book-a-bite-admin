...
import 'package:admin_bite/fcm_controller.dart';
import 'package:admin_bite/pages/Coupons/add_coupons_to_products/add_coupon_data_to_products.dart';
...
//====================================================products coupon edit
      await firebaseFirestore
        ...
        for (var element in value.docs) {
          var docRef =
              FirebaseFirestore.instance.collection('products').doc(element.id);
          docRef.update(
            {
              'couponStatus': true,
                        ...
                        Container(
                          ...
                          child: DateTimePicker(
                            ...
                            decoration: InputDecoration(
                                ...
                                fillColor: Global.deepOrange,
                                prefixIconColor: Global.deepOrange,
                                suffixIconColor: Global.deepOrange),
