import 'package:admin_bite/pages/bitehub/biteHubDetails.dart';
import 'package:admin_bite/pages/customers/widgets/customerDetails.dart';
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '\$${widget.documentSnapshot!.get('product_list')[index]['dis_price'].toString()}',
                                              style: TextStyle(
                                                  fontFamily: "Nunito",
                                                  fontSize: 18,
                                                  fontWeight: FontWeight.bold,
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "\$${widget.documentSnapshot!.get('total_price')}",
                                          style: TextStyle(
                                              fontFamily: "Nunito",
                                              fontSize: 15,
                                              fontWeight: FontWeight.bold,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "\$${widget.documentSnapshot!.get('coupon_discount')}",
                                          style: TextStyle(
                                              fontFamily: "Nunito",
                                              fontSize: 15,
                                              fontWeight: FontWeight.bold,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "\$${widget.documentSnapshot!.get('net_price') - double.parse(widget.documentSnapshot!.get('coupon_discount').toString())}",
                                          style: TextStyle(
                                              fontFamily: "Nunito",
                                              fontSize: 15,
                                              fontWeight: FontWeight.bold,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "\$${widget.documentSnapshot!.get('net_price') - ((int.parse(widget.restDocumentSnapshot!.get('commission').toString()) ~/ 100))}",
                                          style: TextStyle(
                                              fontFamily: "Nunito",
                                              fontSize: 15,
                                              fontWeight: FontWeight.bold,
